...
label choice_1_2:
    ...
    j "So, the breed is what's known locally as a \'Prius\', which is kind of a thoroughbred for my job."
    j "So, I named him Seabiscuit after this famous racehorse."
    j "Which is funny because he is {i}not{/i} fast.{p}But he is efficient! Which counts for something."
    a "Wow. I've never met a horse, but I asked Mom for a tuna one time."
    a "I dug a pit back behind the house and filled it with water."
    ...
    a "I'd love to have my own familiar someday."
    a "A living one, I mean. I'd feed it and take it for walks. Like the tuna!"
    a "If it was pretty small, I could probably even keep it in my room with me. Then we could play all day!"
...
label resume_1:
    ...
    q1 "No, I'm telling you it's not possible! The gouges are too deep for a bear!"
    q2 "And I'm saying you don't even hang out with bears! I've met some pretty big bears."
    q2 "I had a nursery mate, a fir, who was the local rub tree for some real grizzly types."
    q2 "They'd take whole chunks out of him sometimes, but, like, he never gave his safe word or anything, so I think it was all above board."
    q1 "...was that a pun, Toorg? You know how I feel about puns."
    ...
    j "It's just Jo. I'm chaperoning this precocious child."
    a "We are bound by venerable purpose.{p}We have set upon a {shader=jitter:3.0,3.0}MIGHTY QUEST!{/shader}"
    j "Yeah, so-"
    a "{shader=jitter:3.0,3.0}WE SEEK TO CAPTURE THE TERRIBLE BOG BEAST! FATED COMPATRIOTS, WILL YOU JOIN US IN THIS QUEST, OR ARE YOU COWARDS?!{/shader}"
    ...
    j "Aria, have you been disappearing people from the woods?"
    a "No..."
    n "She says it sadly, like you've knocked the wind from her sails."
    t "While your partner there looks like they're packing some potent scratchers, I don't think you're capable of that kind of damage."
    n "The tree-man gestures to a thick trunk nearby. It's bark has been raked through, leaving deep gouges in the hard wood underneath."
