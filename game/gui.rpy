...
define gui.hover_color = '#e06a66f8'
...
# Set this way so the bog beast name color will match when you name him
define gui.input_text_color = '#3d7a00'
...
define gui.main_menu_background = "menu loop"
